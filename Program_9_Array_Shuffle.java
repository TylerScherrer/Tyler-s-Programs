public class Program_9_Array_Shuffle {
	...
	public static void shuffleDeck(int[] deck) {			// The Method shuffleDeck creates 2 random generated numbers between 1-36 and puts them into integers random and randomTwo
			...
			int random = (int)(Math.random() * 35 - 1) + 1; // The value that integer temp was holding onto is then swapped into integer random to complete the full swap between the two variables.
			int randomTwo = (int)(Math.random() * 35 - 1) + 1; // This loop runs 600 times to provide a shuffled look to the Array
